...
class MyManageExerciseVideo extends StatelessWidget {
  final String image,title,detail;
  final bool isadd;
  const MyManageExerciseVideo({required this.isadd,required this.image,required this.detail,required this.title,super.key});
